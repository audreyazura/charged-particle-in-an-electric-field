...
for E in Efields:
	...
	for pos in notchPositions:
		...
		print(" ".join(["File", accelerationFile, "created."]))
		...
		for xi in xinits:
			...
			if not(path.isfile(backSlowFile)):
				...
				print("".join(["Beginning of velocity calculation for x_notch = ", pos, " nm and x_initial = ", str(xi), "nm."]))
				pbar = ProgressBar()
				...
				print("".join(["Calculation ended for x_notch = ", pos, " nm and x_initial = ", str(xi), "nm."]))
				...
				print(" ".join(["File", exitFile, "created."]))
				...
				print(" ".join(["File", meanFile, "created."]))
				...
				print(" ".join(["File", frontFastFile, "created."]))
				...
				print(" ".join(["File", frontSlowFile, "created."]))
				...
				print(" ".join(["File", frontMeanFile, "created."]))
				...
				print(" ".join(["File", backFastFile, "created."]))
				...
				print(" ".join(["File", backSlowFile, "created."]))
				...
				print(" ".join(["File", backMeanFile, "created."]))
